...
fun main(){
    ...
    leaf1.DisplayNodeLeaf()   //  Leaf File

    println("Display the leaf on Node 1 on composite")
    composite1.DisplayNodeLeaf() // Leaf file Leaf New

    println("Display the leaf on Node 2 on composite")
    composite2.DisplayNodeLeaf()  // LeF EDIT LEAF COPY
