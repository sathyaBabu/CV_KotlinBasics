...
fun dateProgression() {
    ...
    val Jul_4th_22  = LocalDate.of(2022,7,4)
    val Jul_11th_22 = LocalDate.of(2022,7,11)

    if( LocalDate.now() in  Jul_4th_22  .. Jul_11th_22){
...
fun dateProgressionToFeedMyFish() {
    ...
    val Jul_4th_22  = LocalDate.of(2022,7,4)
    val Jul_11th_22 = LocalDate.of(2022,7,11)
    val start_day_month = Jul_4th_22.dayOfMonth
    val end_day_month   = Jul_11th_22.dayOfMonth
/*
 ...
 */
    for( presentDay in start_day_month .. end_day_month){
        ...
        var day_of_week = LocalDate.of(2022,7,presentDay).dayOfWeek
        ...
        if( day_array.contains(day_of_week.toString()))
             println("Feed the fish on date : " +
                     "${LocalDate.of(2022,7,presentDay)} and day is ${day_of_week} ")
...
fun expresssive_in_is_as() {
  ...
  //  if( "Mango" in fruits)
    ...
    println(" Frekey is ${"Sathya " is String}")
